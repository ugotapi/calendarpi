...
and display it on your TV full screeen using ICS Calendar plugin in WordPress. I use the freee version of ICS Calendar, but there are great options for displaying a calendar under the [
](https://icscalendar.com/product/ics-calendar-pro) paid for version.
